...
class Test:
    ...
    def st(self):
        do_at_sometime(do_something_at_regular_intervals, run_time=3, countdown=True, args=[self.pr, 3], if_block=True)
...
if __name__ == "__main__":
    ...
    # do_at_sometime(do_something_at_regular_intervals, run_time=3, countdown=True, args=[, 3], if_block=True)
    test = Test()
    test.st()
